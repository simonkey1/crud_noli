...
# Ruta del archivo de configuración de Mercado Pago
CONFIG_FILE = os.path.join(os.path.dirname(__file__), 'mp_test_users.json')
...
def main():
    ...
    print("Para completar la configuración, necesitas el ACCESS TOKEN del vendedor.")
    print("Puedes obtenerlo en: https://www.mercadopago.com.cl/developers/panel/credentials")
    print("Inicia sesión con el email del vendedor.")
    
    access_token = input("Ingresa el ACCESS TOKEN del vendedor: ")
    public_key = input("Ingresa el PUBLIC KEY del vendedor: ")
